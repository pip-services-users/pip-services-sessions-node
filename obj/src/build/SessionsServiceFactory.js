...
class SessionsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
SessionsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "factory", "default", "default", "1.0");
SessionsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "persistence", "memory", "*", "1.0");
SessionsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "persistence", "file", "*", "1.0");
SessionsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "persistence", "mongodb", "*", "1.0");
SessionsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "controller", "default", "*", "1.0");
SessionsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "service", "seneca", "*", "1.0");
SessionsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sessions", "service", "http", "*", "1.0");
