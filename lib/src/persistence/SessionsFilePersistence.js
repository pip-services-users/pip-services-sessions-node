...
var SessionsFilePersistence = (function (_super) {
    __extends(SessionsFilePersistence, _super);
    function SessionsFilePersistence(descriptor) {
        _super.call(this, descriptor || SessionsFilePersistence.Descriptor);
    }
    SessionsFilePersistence.prototype.configure = function (config) {
        _super.prototype.configure.call(this, config);
        this._handler = new SessionsHandler_1.SessionsHandler(config.getOptions());
    };
    SessionsFilePersistence.prototype.getSessions = function (correlationId, userId, callback) {
        this.getById(userId, function (err, item) {
            if (err || item == null) {
                callback(err, null);
                return;
            }
            var sessions = _.cloneDeep(item.sessions);
            callback(null, sessions);
        });
    };
    SessionsFilePersistence.prototype.loadSession = function (correlationId, userId, sessionId, callback) {
        var _this = this;
        this.getById(userId, function (err, item) {
            if (err || item == null) {
                callback(err);
    ...
    SessionsFilePersistence.prototype.openSession = function (correlationId, user, address, client, data, callback) {
        var _this = this;
        ...
        this.getById(user.id, function (err, item) {
            if (err) {
                callback(err);
                return;
            }
    ...
    SessionsFilePersistence.prototype.storeSessionData = function (correlationId, userId, sessionId, data, callback) {
        var _this = this;
        this.getById(userId, function (err, item) {
            if (err || item == null) {
                callback(err);
    ...
    SessionsFilePersistence.prototype.closeSession = function (correlationId, userId, address, client, callback) {
        var _this = this;
        this.getById(userId, function (err, item) {
            if (err || item == null) {
                if (callback)
    ...
    SessionsFilePersistence.prototype.deleteSession = function (correlationId, userId, sessionId, callback) {
        var _this = this;
        this.getById(userId, function (err, item) {
     ...
     */
    SessionsFilePersistence.Descriptor = new pip_services_runtime_node_2.ComponentDescriptor(pip_services_runtime_node_1.Category.Persistence, "pip-services-sessions", "file", "*");
    return SessionsFilePersistence;
